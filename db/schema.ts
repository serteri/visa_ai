...
export const fullCheckWaitlist = pgTable("full_check_waitlist", {
  ...
  qualification_awarded_in_australia: boolean("qualification_awarded_in_australia"),
  qualification_regional_australia: boolean("qualification_regional_australia"),
  specialist_education_stem_response: text("specialist_education_stem_response"),
