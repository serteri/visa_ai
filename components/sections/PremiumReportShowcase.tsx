...
/**
 * Homepage section explaining what the A$21.99 inc. GST premium report actually
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg font-medium leading-relaxed text-slate-700">
            {t(
              ...
              "Stop guessing. Get the exact AI-powered blueprint used by migration experts, detailing your precise points, hidden risks, and a clear roadmap to Permanent Residency. All for A$21.99 inc. GST."
            )}
          </p>
        </div>
