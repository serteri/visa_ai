  ...
  return (
    <SelectPrimitive.Portal container={portalContainer}>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-slate-900 text-white data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 absolute z-[10000] max-h-96 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border border-slate-800/50",
          position === "popper" &&
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default select-none items-center gap-2 rounded-sm py-2 pl-2 pr-8 text-sm text-white outline-none data-[highlighted]:bg-slate-800/50 data-[highlighted]:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[disabled]:text-slate-500",
        className
      )}
      {...props}
    >
