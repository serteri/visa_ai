...
export function TermsEn() {
  return (
    <>
      ...
      <p className="text-sm text-slate-400">Last updated: 3 July 2026</p>
...
export function TermsTr() {
  return (
    <>
      ...
      <p className="text-sm text-slate-400">Son güncelleme: 3 Temmuz 2026</p>
...
export function TermsZh() {
  return (
    <>
      <h1>服务条款与退款政策</h1>
      <p className="text-sm text-slate-400">最后更新日期：2026年7月3日</p>
