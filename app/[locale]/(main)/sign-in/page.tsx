    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4 pt-28 pb-16">
      <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-8 shadow-sm text-center">
        <div className="mb-6">
          ...
          <h1 className="mt-3 text-lg font-bold text-slate-900">Sign in to your account</h1>
          <p className="mt-1 text-sm text-slate-500">
            Save your results and track your visa journey.
          </p>
        </div>
        ...
        >
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 hover:border-slate-300"
          >
