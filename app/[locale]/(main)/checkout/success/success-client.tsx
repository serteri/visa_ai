...
/** The success page's UI. `downloadHref` is issued by the server page only after it has verified the Stripe session. */
export function CheckoutSuccessClient({ downloadHref }: { downloadHref: string | null }) {
