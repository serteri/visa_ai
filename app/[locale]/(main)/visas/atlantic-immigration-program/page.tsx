        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr_0.9fr]">
          ...
          <Card className="border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <CardContent className="space-y-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">ID</p>
                <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white">{aipData.id}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">{isTr ? "Ulke" : isZh ? "国家" : "Country"}</p>
                <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white">{l(aipData.country)}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">{isTr ? "Durum" : isZh ? "状态" : "Status"}</p>
                <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white">{l(aipData.status)}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">{isTr ? "Hedef eyaletler" : isZh ? "目标省份" : "Target provinces"}</p>
