        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr_0.9fr]">
          ...
          <Card className="border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <CardContent className="space-y-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">{ui.fee}</p>
                <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white">{feeText}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">{ui.processingTime}</p>
                <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white">{processingTimeText}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">{ui.supportingDocs}</p>
                <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white">{supportingDocuments.length}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">{ui.source}</p>
                <a
                  href={pnp.sourceUrl}
                  target="_blank"
                  rel="noopener noreferrer"
