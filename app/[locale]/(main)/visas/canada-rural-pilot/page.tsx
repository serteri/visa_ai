...
type SharedData = {
  ...
  afterApply?: {
    ...
    biometrics_tr?: { note?: string };
    biometrics_zh?: { note?: string };
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <h1 className="text-3xl font-bold tracking-tight text-slate-950 dark:text-white sm:text-5xl">
                    {localizedField(rcip as unknown as Record<string, unknown>, "name", "Rural Community Immigration Pilot (RCIP)")}
                  </h1>
                  <p className="max-w-3xl text-base leading-7 text-slate-600 dark:text-slate-300 sm:text-lg">
                    {localizedField(rcip as unknown as Record<string, unknown>, "purpose")}
                  </p>
