    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">Your Full Check PDF reports.</p>
        </div>
        <Button asChild>
        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-4 py-16 text-center">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">Complete a Full Check and your PDF report will appear here.</p>
            </div>
