    ...
    <main className="min-h-screen pb-20">
      <div className="mx-auto w-full max-w-5xl px-4 pt-16 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          <span className="cf-mono inline-block rounded-sm border border-[#53917E]/30 bg-[#53917E]/10 px-4 py-1 text-xs font-semibold uppercase tracking-widest text-[#53917E]">
            {isTr ? "ARAÇLAR" : isZh ? "工具" : "TOOLS"}
          </span>
          <h1 className="cf-serif mt-4 text-4xl font-medium tracking-tight text-slate-900 sm:text-5xl">
            {title}
          </h1>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {/* Australia Card */}
          <div className="group relative flex flex-col justify-between overflow-hidden rounded-sm border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
            <div>
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#53917E]/10 text-[#53917E]">
                <Compass className="h-6 w-6" />
              </div>
              <h2 className="cf-serif mt-6 text-2xl font-semibold text-slate-900">
                {auTitle}
              </h2>
            ...
            <div className="mt-8">
              <Link href={`/${locale}/tools/points-calculator/australia`}>
                <button className="flex w-full items-center justify-center gap-2 rounded-sm bg-[#53917E] py-3 text-sm font-semibold text-white shadow-sm transition-all hover:opacity-90">
                  <span>{ctaBtn}</span>
