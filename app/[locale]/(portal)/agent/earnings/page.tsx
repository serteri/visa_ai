    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold uppercase tracking-wide text-indigo-600">Agent</p>
          <h1 className="text-2xl font-bold">Earnings</h1>
          <p className="text-sm text-slate-500">Your referral performance and commission history.</p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          {transactions.length === 0 ? (
            <p className="py-8 text-center text-sm text-slate-500">No commission earned yet.</p>
          ) : (
